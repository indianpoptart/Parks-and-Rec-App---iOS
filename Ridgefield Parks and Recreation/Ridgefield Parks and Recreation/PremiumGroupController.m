...
- (void)viewDidLoad {
	...
	[pgview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://ridgefieldparksandrec.org/wp-content/uploads/Premium-Group-Fitness-Schedule-1.pdf"]]];
